...
@PactTestFor(providerName = "VPCourtSchedulePactProvider", pactVersion = au.com.dius.pact.core.model.PactSpecVersion.V4)
public class CourtScheduleConsumerPactTest {

    @Pact(consumer = "VPCourtSchedulePactConsumer")
