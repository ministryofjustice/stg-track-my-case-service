...
class CaseDetailsDtoTest {
    ...
    void testJsonInclude() throws JsonProcessingException {
        ...
        String expectedCourtHouse = """
            ...
            "courtRoom":[
                {
                "courtRoomId":1,"courtRoomName":"Room 1"},{"courtRoomId":2,"courtRoomName":"Room 2"
                }
            ]
            }
            """;
        ...
        String expectedHearing = "{\"hearingId\":\"H001\",\"hearingType\":\"Trial\",\"hearingDescription\":\"Main hearing\",\"listNote\":\"List note\","
            + "\"courtSittings\":[" + expectedSitting + "],\"weekCommencing\":" + expectedWeekCommencing + "}";
        String expectedCourtSchedule = "{\"hearings\":[" + expectedHearing + "]}";
        String expected = "{\"caseUrn\":\"URN123\",\"caseStatus\":\"ACTIVE\",\"courtSchedule\":[" + expectedCourtSchedule + "]}";
        assertEquals(objectMapper.readTree(expected).toString(), objectMapper.writeValueAsString(dto1));
