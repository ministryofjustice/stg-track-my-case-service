...
public class ProsecutionCaseOAuthTokenClient {
    ...
    @Getter
    @Value("${services.oauth-token.prosecutioncase-tenant-id}")
    ...
    @Getter
    @Value("${services.oauth-token.prosecutioncase-client-id}")
    private String clientId;

    @Getter
    @Value("${services.oauth-token.prosecutioncase-client-secret}")
    private String clientSecret;

    @Getter
    @Value("${services.oauth-token.prosecutioncase-scope}")
